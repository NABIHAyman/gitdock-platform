...
import { ref } from 'vue'
import BadgeSection from '@/components/dashboard/manager/BadgeSection.vue'
import TagSection from '@/components/dashboard/manager/TagSection.vue'
import LevelSection from '@/components/dashboard/manager/LevelSection.vue'
        ...
        <div class="p-4 border-t border-slate-100">
          <div class="flex items-center gap-3 px-2 py-2">
            ...
            <div class="flex flex-col">
              <span class="text-xs font-bold">Admin PFA</span>
              <span class="text-[10px] text-slate-400">Software Engineer</span>
            </div>
          </div>
        </div>
      </aside>
