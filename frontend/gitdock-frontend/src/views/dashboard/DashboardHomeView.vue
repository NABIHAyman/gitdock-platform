...
// const AI_API = import.meta.env.VITE_AI_API_URL || 'http://localhost:8080/api/ai'
...
const analyzeProject = async () => {
  ...
  aiResult.value = null
  try {
    const res = await api.get(`/v1/analyze-project`, {
...
const loadGlobalReport = async () => {
  ...
  try {
    ...
    const res = await api.get(`/v1/analyze-all`, {
