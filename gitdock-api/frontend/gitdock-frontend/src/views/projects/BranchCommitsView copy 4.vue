            ...
            <tbody class="divide-y divide-slate-100">
              <template v-for="commit in projectStore.commits" :key="commit.id">
                ...
                <tr v-if="expandedCommitId === commit.hash">
                  <td colspan="5" class="p-0 bg-[#f6f8fa] border-b border-indigo-100 shadow-inner max-w-0">
...
<style>
/* 🎯 LE BOUCLIER ANTI-TAILWIND POUR DIFF2HTML */
...
/* 1. On annule l'effet destructeur de Tailwind sur le box-sizing des éléments internes */
.diff2html-container * {
  box-sizing: content-box !important;
}

/* 2. On ressuscite les tables HTML classiques ! */
.diff2html-container table {
...
/* 3. On force le code à rester sur une ligne avec scroll horizontal */
...
/* --- NETTOYAGE VISUEL (Couleurs et Bordures) --- */
.d2h-file-wrapper {
...
.d2h-file-header {
  display: none !important; /* Cache l'en-tête natif moche */
}
...
.d2h-code-side-linenumber {
  position: static !important; /* Détruit la barre verticale clignotante */
}
</style>