...
import UserHeader from '../components/dashboard/user/UserHeader.vue'
import UserStats from '../components/dashboard/user/UserStats.vue'
import UserBadges from '../components/dashboard/user/UserBadges.vue'
...
const userData = ref({
  fullName: 'Rihab B.',
  role: 'Software Engineer', // Peut être 'Tester', 'Consultant', etc.
  level: 4,
  currentXP: 1450,
  nextLevelXP: 2000,
  stats: {
