 ...
 */
final class Version20260509232944 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE task DROP level_id, DROP deleted_at, DROP assigned_by, DROP part_id');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE task ADD level_id INT DEFAULT NULL, ADD deleted_at DATETIME DEFAULT NULL, ADD assigned_by INT DEFAULT NULL, ADD part_id INT DEFAULT NULL');
    }
}
